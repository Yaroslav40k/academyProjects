...
public class EmailUtil {
	...
	public static Session createSession (String fromUserId, String password ) {
	...
	public  static String sendMessage(Session session, String customerName, String customerEmail, String to, String subject, String messageText) {
