...
<body>
	...
	<div class="generic-container">
		...
		<div class="well lead">Choose Faction</div>
			...
			<table>
				<tr>
					<c:forEach items="${factions}" var="faction">
						<tr>
							<td><a href="<c:url value='/orders/stage4-${faction.faction_id}' />"
								class="btn btn-success ">${faction.factionName}</a></td>
						</tr>
					</c:forEach>
				</tr>
			</table>
